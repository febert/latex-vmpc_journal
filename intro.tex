...
\begin{figure}[t]
	...
	\caption{\todo{add more detailed caption that discusses generality of the model learned through self-supervision.}\small{Example trajectories for different tasks, solved by Visual MPC}}
