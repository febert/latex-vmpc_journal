...
%%SL.11.21: some writing issue here (malformed sentence)
...
%%SL.11.21: There is a lot of abuse of ``'' in this section, don't use quotation marks so much. Besides this, I think this paragraph is very problematic right now because (1) it is not well motivated and (2) it's not actually clear what we do. This will come across as a huge hack. Maybe some of that is inevitable, but I think we can do much better.
