...
%%SL.10.15: Don't use "we propose" for intermediate variants of the method like this (generally "propose" is kind of overused in the paper right now)
...
%%SL.10.15: This paragraph kind of obscures the main point, which is that we now have a goal image... kind of a huge change, but not really explained.
...
%%SL.10.15: maybe use \noindent \textbf{} paragraph heading instead of subsubsection?
...
%%SL.10.15: consider using \textbf instead?
...
%%SL.10.15: consider using \textbf? I'm guessing you meant this to be nested under 5.2
