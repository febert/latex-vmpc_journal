...
\title{Robotic Manipulation \\ 
Using Video-prediction Models}
%
%
...
\author{Frederik Ebert, Chelsea Finn, Alex Lee, Anni Xie, Sudeep Dasari, Sergey Levine
        
\IEEEcompsocitemizethanks{
\IEEEcompsocthanksitem The authors are with UC Berkeley}% <-this % stops an unwanted space
...
\begin{IEEEkeywords}
Robotic Manipulation, Visio-Motor Control, Video-prediction, Model-predictive Control, Self-supervised Learning
\end{IEEEkeywords}}
